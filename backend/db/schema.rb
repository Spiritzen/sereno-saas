...
ActiveRecord::Schema[8.1].define(version: 2026_08_20_100000) do
  ...
  create_table "comptes_destinataires", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "email", null: false
    t.string "mot_de_passe_hash", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_comptes_destinataires_on_email", unique: true
  end
  ...
  create_table "destinataire_client_links", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "client_id", null: false
    t.uuid "compte_destinataire_id", null: false
    t.datetime "created_at", null: false
    t.string "cree_via", null: false
    t.uuid "facture_id_preuve", null: false
    t.datetime "updated_at", null: false
    t.index ["client_id"], name: "index_destinataire_client_links_on_client_id"
    t.index ["compte_destinataire_id", "client_id"], name: "index_destinataire_client_links_uniq", unique: true
    t.index ["compte_destinataire_id"], name: "index_destinataire_client_links_on_compte_destinataire_id"
  end

  create_table "destinataire_sessions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "compte_destinataire_id", null: false
    t.datetime "created_at", null: false
    ...
    t.datetime "updated_at", null: false
    t.index ["compte_destinataire_id"], name: "index_destinataire_sessions_on_compte_destinataire_id"
    t.index ["token_hash"], name: "index_destinataire_sessions_on_token_hash", unique: true
  end
  ...
  create_table "evenement_avoir", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["avoir_id", "created_at"], name: "index_evenement_avoir_on_avoir_and_created_at"
    t.index ["avoir_id"], name: "index_evenement_avoir_on_avoir_id"
    t.index ["organisation_id", "avoir_id"], name: "index_evenement_avoir_on_org_and_avoir"
  ...
  create_table "evenement_devis", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "statut::text = ANY (ARRAY['brouillon'::character varying::text, 'envoye'::character varying::text, 'accepte'::character varying::text, 'refuse'::character varying::text])", name: "check_evenement_devis_statut"
  end
  ...
  create_table "evenement_entrant_pa", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["avoir_id"], name: "index_evenement_entrant_pa_on_avoir_id"
    ...
    t.index ["organisation_id", "avoir_id"], name: "index_evenement_entrant_pa_on_org_and_avoir"
  ...
  create_table "organisations", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "fait_generateur_tva::text = ANY (ARRAY['debits'::character varying::text, 'encaissements'::character varying::text])", name: "check_organisations_fait_generateur_tva"
  ...
  create_table "relances", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "origine::text = ANY (ARRAY['manuel'::character varying::text, 'planifie'::character varying::text])", name: "check_relances_origine"
  ...
  create_table "transmission_pa", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["identifiant_pa"], name: "index_transmission_pa_on_identifiant_pa_unique", unique: true, where: "(identifiant_pa IS NOT NULL)"
  ...
  create_table "utilisateurs", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index "lower(TRIM(BOTH FROM email))", name: "index_utilisateurs_on_email_normalise_unique", unique: true
  ...
  add_foreign_key "destinataire_client_links", "clients"
  add_foreign_key "destinataire_client_links", "comptes_destinataires", column: "compte_destinataire_id"
  add_foreign_key "destinataire_client_links", "factures", column: "facture_id_preuve"
  add_foreign_key "destinataire_sessions", "comptes_destinataires", column: "compte_destinataire_id"
